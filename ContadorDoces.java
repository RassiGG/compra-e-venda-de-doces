...
public class ContadorDoces {
    ...
    public ContadorDoces() {
       ...
       ImageIcon imgBeijinho = new ImageIcon("beijinho.jpg");
        ImageIcon imgBrigadeiro = new ImageIcon("bri.jpeg");
        ImageIcon imgCajuzinho = new ImageIcon("cajuzinho.jpg");
        ImageIcon imgPacoca = new ImageIcon("pacoca.jpg");
        ImageIcon imgPeDeMoleque = new ImageIcon("pedemoleque.jpg");
        ...
        // Labels de contagem
        labelContagemBeijinho = new JLabel("Quantidade: ");
        labelContagemBrigadeiro = new JLabel("Quantidade: ");
        labelContagemCajuzinho = new JLabel("Quantidade: ");
        labelContagemPacoca = new JLabel("Quantidade: ");
        labelContagemPeDeMoleque = new JLabel("Quantidade: ");
